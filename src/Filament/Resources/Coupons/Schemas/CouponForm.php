                ...
                ->schema([
                    \Filament\Schemas\Components\Section::make()
                        ->schema([
                            ...
                            \App\Filament\Components\Form\TypeSelect::create(Coupon::class)
                                ->required()
                                ->reactive(),
                            \App\Filament\Components\Form\DescriptionTextarea::create(),
                            \App\Filament\Components\Form\ConditionalAmountTextInput::create(),
                            \App\Filament\Components\Form\ConditionalPercentageTextInput::create(),
                            \App\Filament\Components\Form\ConditionalMaxPercentageAmountTextInput::create(),
